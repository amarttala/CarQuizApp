		...
		`<div>
            <form class="questionForm" method="post">
                <fieldset>
                    ...
                    <label>
                        <input type="radio" name="cars" value=0 required>
...
function formSubmit() {
    $('.questionForm').submit(function(event) {
        ...
        const userAnswer = parseInt($('input[name="cars"]:checked').val());
...
function choseRightAnswer() {
    ...
    $('.questionBox').html(
        `<div>
            ...
            <img src="Correct.png" class="right" alt="Right">
            <p>${explanation}</p>
...
function choseWrongAnswer() {
    ...
    $('.questionBox').html(
        `<div>
            <strong>Wrong<strong>
            <img src="Wrong.png" class="wrong" alt="Wrong">
            <p>${explanation}</p>
            <button class="nextButton">Next Question</button>
        </div>`
    );
